...
`v0.2.0` Git tag has completed the release workflow:
...
The chart defaults to the matching immutable release tag. For a private GHCR
package, authenticate first with `helm registry login ghcr.io` using a token
