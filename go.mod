module github.com/canberkturan/keda-replica-sense
...
// KEDA v2.20.2 builds against this Kubernetes patch release. Replace
// directives in a dependency's go.mod are not inherited by consuming modules,
// so ReplicaSense pins the same compatibility set explicitly.
replace (
